...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Battery Note</b></em>',
 ...
 * @generated
 */
public enum BatteryNote implements Enumerator {
	/**
	...
	*/
	...
	/**
	 * An array of all the '<em><b>Battery Note</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final BatteryNote[] VALUES_ARRAY = new BatteryNote[] { SNARE_DRUM, BASS_DRUM, CLOSED_HIHAT,
			OPENED_HIHAT, CRASH_CYMBAL, RIDE_CYMBAL, EMPTY, };

	/**
	 * A public read-only list of all the '<em><b>Battery Note</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<BatteryNote> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Battery Note</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static BatteryNote get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BatteryNote result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Battery Note</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static BatteryNote getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BatteryNote result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Battery Note</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static BatteryNote get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private BatteryNote(int value, String name, String literal) {
		this.value = value;
		this.name = name;
