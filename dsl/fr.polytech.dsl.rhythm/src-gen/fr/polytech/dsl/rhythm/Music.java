 ...
 * </p>
 * <ul>
 *   <li>{@link fr.polytech.dsl.rhythm.Music#getTracks <em>Tracks</em>}</li>
 *   <li>{@link fr.polytech.dsl.rhythm.Music#getSections <em>Sections</em>}</li>
 * </ul>
 *
...
public interface Music extends NamedElement {
	 ...
	 * @see fr.polytech.dsl.rhythm.RhythmPackage#getMusic_Tracks()
	 ...
	 * @see fr.polytech.dsl.rhythm.RhythmPackage#getMusic_Sections()
