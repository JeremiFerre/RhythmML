 ...
 * @generated
 */
public class InstrumentItemProvider extends NamedElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Instrument) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Instrument_type")
