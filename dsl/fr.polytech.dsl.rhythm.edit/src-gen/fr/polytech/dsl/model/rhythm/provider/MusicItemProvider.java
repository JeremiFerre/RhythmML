...
public class MusicItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSoundBankPathPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Sound Bank Path feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSoundBankPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Music_soundBankPath_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Music_soundBankPath_feature",
								"_UI_Music_type"),
						RhythmPackage.Literals.MUSIC__SOUND_BANK_PATH, true, false, false,
